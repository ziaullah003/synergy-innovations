    ...
    <div className="min-h-screen bg-blue-50 py-8 px-6">
      <div className="max-w-7xl mx-auto">
        ...
        <div className="text-center mb-5">
          ...
          <h1 className="text-3xl md:text-7xl lg:text-6xl font-bold text-black mb-3 leading-none">
            Our 
            <span className="text-blue-800"> Collective</span>
          </h1>
          <p className="text-xl md:text-xl text-black font-medium max-w-5xl mx-auto leading-relaxed">
          ...
          <div className="bg-white rounded-3xl p-2 shadow-2xl border border-blue-100">
            <div className="flex space-x-3">
              <button
                ...
                className={`flex items-center space-x-4 px-10 py-1 rounded-2xl font-bold text-md transition-all duration-500 transform ${
              ...
              >
                ...
                <div className="bg-white bg-opacity-25 px-3 py-1 rounded-full text-sm font-bold">
                  {currentTeam.length}
                </div>
              </button>
              <button
                onClick={() => switchCategory('alumni')}
                className={`flex items-center space-x-4 px-10 py-2 rounded-2xl font-bold text-lg transition-all duration-500 transform ${
        ...
        <div className="relative">
          ...
          <div 
            ...
            className="flex space-x-6 overflow-x-auto px-16 py-12"
            style={{
              scrollbarWidth: 'none',
          ...
          >
            {currentData.map((member) => (
              ...
              >
                <div className="bg-white rounded-3xl p-5  shadow-xl hover:shadow-2xl transition-all duration-700 transform hover:-translate-y-8 hover:scale-105 border border-blue-100">
                  <div className="text-center space-y-6 h-full flex flex-col">
                    {/* Profile Section */}
                    <div className="relative mx-auto">
                      <div className="w-32 h-32 rounded-3xl bg-blue-300 p-1 mx-auto shadow-2xl transform rotate-3 group-hover:rotate-0 transition-transform duration-500">
                        <img 
                          src={member.img} 
                      ...
                      {activeCategory === 'current' ? (
                        <div className="grid grid-cols-1 ">
                          <div className="bg-blue-300 rounded-2xl p-2 border border-blue-200">
                            ...
                            <span className=" text-black">{member.joinedYear}</span>
                        ...
                        <div className="bg-blue-300 rounded-2xl p-2 border border-blue-200">
                          <div className="flex items-center justify-center space-x-2 mb-2">
                            ...
                            <span className=" font-bold text-black uppercase">Left</span>
                            <span className=" font-bold text-black">{member.endYear}</span>
                          </div>
