            ...
            <div className="px-4 sm:w-2/12 lg:w-4/12">
              <div className="mb-3">
                <div className="flex items-center">
                  <a href="/synergy-club" className="mb-6 inline-block max-w-[50px]">
                    <img
                      src="/logo.png"
                      alt="logo"
                  ...
                  <h1 className="text-xl ml-5 font-bold text-dark dark:text-white">
                    Synergy <span className="text-blue-950">Club</span>
                  </h1>
                </div>
                <p className="mb-4 text-base text-body-color dark:text-dark-6">
                  Building connections, fostering innovation, and creating opportunities for growth through collaborative learning and community engagement. Join us in shaping the future together.
                </p>
            ...
            <div className="w-full px-4 sm:w-1/2 lg:w-3/12">
              <div className="mb-10">
                ...
                <p className="text-base text-body-color dark:text-dark-6">
                  &copy; 2025 Synergy Club | Part of Synergy Innovations
                </p>
              </div>
            </div>
          </div>
