        ...
        <div className="container flex items-center justify-center">
          <div className="-mx-4 flex flex-wrap justify-between">
            <div className=" px-4 sm:w-2/12 lg:w-4/12">
              <div className="mb-3">
                ...
                <a href="/#" className="mb-6 inline-block max-w-[50px]">
                 ...
                 <h1 className="text-xl ml-5 font-bold text-dark dark:text-white">Synergy Innovations</h1>
            </div>
                ...
                <p className="flex items-center text-sm font-medium text-dark dark:text-white">
                  ...
                  <div>
                  <span>+92 (325) 170 50 43</span> <br></br>
            ...
            <LinkGroup header="Our Products">
              <NavLink link="/#" label="Software Synergy Solutions" />
              <NavLink link="/#" label="Software Synergy Club" />
              <NavLink link="/#" label="Synergy Mall" />
