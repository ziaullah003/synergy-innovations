    ...
    <div className="min-h-screen bg-gradient-to-br from-slate-50 via-blue-50 to-indigo-100 py-12 px-4">
      <div className="max-w-6xl mx-auto">
        ...
        <div className="text-center mb-12">
          ...
          <h1 className="text-4xl md:text-6xl font-bold bg-gradient-to-r from-gray-900 via-blue-700 to-indigo-600 bg-clip-text text-transparent mb-4 leading-tight">
            Let's Build Something
          </h1>
          <h2 className="text-3xl md:text-5xl font-bold bg-gradient-to-r from-blue-600 to-cyan-500 bg-clip-text text-transparent mb-6 leading-tight">
            Amazing Together
          </h2>
            ...
            <div className="bg-white/80 backdrop-blur-sm rounded-2xl p-6 border border-gray-200 hover:border-blue-400 transition-all duration-300 transform hover:scale-105 shadow-lg hover:shadow-xl">
              ...
              <div className="space-y-4">
                <div className="flex items-center gap-4 group">
                  <div className="p-3 bg-gradient-to-r from-blue-500 to-blue-400 rounded-lg group-hover:scale-110 transition-transform duration-300">
                    <Mail className="w-5 h-5 text-white" />
                  </div>
                  <div>
                    <p className="text-gray-500 text-sm">Email</p>
                    <p className="text-gray-800 font-semibold">hello@softwarehouse.com</p>
                  </div>
                </div>
                
                <div className="flex items-center gap-4 group">
                  <div className="p-3 bg-gradient-to-r from-blue-400 to-cyan-400 rounded-lg group-hover:scale-110 transition-transform duration-300">
                ...
                <div className="flex items-center gap-4 group">
                  <div className="p-3 bg-gradient-to-r from-cyan-500 to-blue-400 rounded-lg group-hover:scale-110 transition-transform duration-300">
                    <MapPin className="w-5 h-5 text-white" />
                  </div>
                  <div>
                    <p className="text-gray-500 text-sm">Office</p>
                    <p className="text-gray-800 font-semibold">Tech Hub, Innovation District</p>
                  </div>
                </div>
              </div>
            </div>
            ...
            <div className="bg-gradient-to-r from-blue-500/10 to-cyan-500/10 backdrop-blur-sm rounded-2xl p-6 border border-blue-300/50 shadow-lg">
              <div className="grid grid-cols-2 gap-4">
                <div className="text-center">
                  ...
                  <div className="text-blue-600 text-sm font-medium">Projects Delivered</div>
                </div>
                <div className="text-center">
                  <div className="text-3xl font-bold text-gray-800 mb-1">98%</div>
                  <div className="text-blue-600 text-sm font-medium">Client Satisfaction</div>
                </div>
                <div className="text-center">
                  <div className="text-3xl font-bold text-gray-800 mb-1">24/7</div>
                  <div className="text-blue-600 text-sm font-medium">Support</div>
                </div>
                <div className="text-center">
                  <div className="text-3xl font-bold text-gray-800 mb-1">5+</div>
                  <div className="text-blue-600 text-sm font-medium">Years Experience</div>
                </div>
              </div>
            </div>
          </div>
