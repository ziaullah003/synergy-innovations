...
export default function HeroSS() {
  ...
  <h1
    className="max-w-md text-blue-900 bg-clip-text text-center text-3xl font-bold sm:max-w-6xl sm:text-5xl">
  ...
  <div class="mt-12 grid grid-cols-1 gap-8 sm:grid-cols-2 sm:gap-0 sm:gap-x-4">
    <a href="https://example.com/new-feature"
      class="flex flex-row items-center justify-center gap-x-2 rounded-lg text-white px-10 py-3 bg-blue-800">
